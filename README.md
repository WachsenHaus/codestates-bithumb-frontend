...
>>>>>>> d29ec20e695df659d817caecbf377abfd658437b
...
5. 웹소켓은 3개의 웹소켓을 생성하였습니다, ticker, transition, orderbook 3개의 웹소켓이 메세지를 수신하면 각 리코일 상태저장소로 데이터가 저장되게 구현하였습니다.
6. 위 3개 상태의 값들을 각각의 ui에서 조회하고 사용하기 때문에 immer라이브러리를 적극적으로 사용하였습니다.
...
3. UI 크게 신경을 쓰지 못한점이 아쉬움이 남습니다.

4. 최적화를 더 잘하고 싶었는데 조금 아쉬운듯합니다.
...
3. 클라이언트에서 서버로 요청가능한 웹소켓은 최대 몇개까지 가능한가???
4. 빗썸이나 다른 거래소는 어떻게 빨리 데이터가 나오는가?
   > > > > > > > d29ec20e695df659d817caecbf377abfd658437b
